...
func (iq *ItemQuery) QueryProducts() *ProductQuery {
...
func (iq *ItemQuery) WithProducts(opts ...func(*ProductQuery)) *ItemQuery {
	query := (&ProductClient{config: iq.config}).Query()
...
func (iq *ItemQuery) sqlAll(ctx context.Context, hooks ...queryHook) ([]*Item, error) {
	...
	if query := iq.withProducts; query != nil {
		if err := iq.loadProducts(ctx, query, nodes,
			func(n *Item) { n.Edges.Products = []*Product{} },
			func(n *Item, e *Product) { n.Edges.Products = append(n.Edges.Products, e) }); err != nil {
			return nil, err
		}
	}
	return nodes, nil
...
func (iq *ItemQuery) loadProducts(ctx context.Context, query *ProductQuery, nodes []*Item, init func(*Item), assign func(*Item, *Product)) error {
	...
	query.Where(predicate.Product(func(s *sql.Selector) {
		s.Where(sql.InValues(s.C(item.ProductsColumn), fks...))
	}))
